...
char *parse_filepath(int argc, char *argv[]) { 
    /*extrae la ruta del archivo, argc cuenta cuantas palabras escribi en la terminal para ejecutar el programa
    argv es un arreglo de strings, argv[0] nombre del programa y argv[1] es el archivo 
